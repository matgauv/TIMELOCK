...
const float BOSS_ONE_ON_GROUND_Y_POSITION = 480.f; // TODO: need to verify this
...
const float BOSS_ONE_SECOND_DELAYED_PROJECTILE_X_POSITION = 800.f; // for testing purposes
...
const float BOSS_ONE_THIRD_DELAYED_PROJECTILE_X_POSITION = 1100.f; // for testing purposes
