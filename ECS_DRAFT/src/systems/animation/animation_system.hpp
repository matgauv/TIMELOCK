...
private:
	...
	*/ 
	const std::unordered_map<ANIMATION_ID, AnimationConfig> animation_collections = {
		...
		{ANIMATION_ID::ROLLING_THING_1, AnimationConfig(TEXTURE_ASSET_ID::ROLLING_THING_1, ANIMATION_TYPE_ID::FREEZE_ON_LAST , 33, 1500.0)},
		{ANIMATION_ID::ROLLING_THING_2, AnimationConfig(TEXTURE_ASSET_ID::ROLLING_THING_2, ANIMATION_TYPE_ID::FREEZE_ON_LAST , 33, 1500.0)},
