...
private:
	...
	*/ 
	const std::unordered_map<ANIMATION_ID, AnimationConfig> animation_collections = {
		...
		// {ANIMATION_ID::BOSS_ONE_WALK, AnimationConfig(TEXTURE_ASSET_ID::BOSS_ONE_WALK, ANIMATION_TYPE_ID::CYCLE)},
		// {ANIMATION_ID::BOSS_ONE_DASH, AnimationConfig(TEXTURE_ASSET_ID::BOSS_ONE_DASH_LEFT_RIGHT, ANIMATION_TYPE_ID::CYCLE)},
		// {ANIMATION_ID::BOSS_ONE_GROUND_SLAM, AnimationConfig(TEXTURE_ASSET_ID::BOSS_ONE_GROUND_SLAM, ANIMATION_TYPE_ID::CYCLE)}
	};
