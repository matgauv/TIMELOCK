...
class BossAttackSystem : public ISystem
{
    ...
    private:
        ...
        void handleBossOneAttack(Entity& boss_entity, float elapsed_time);
        void handleBossTwoAttack(Entity& boss_entity, float elapsed_time);
        void handleFinalBossAttack(Entity& boss_entity, float elapsed_time);
