...
private:
	...
	void handle_player_object_collision(Entity player_entity, Entity object_entity, Collision collision, float step_seconds, bool* playerIsGrounded, bool* playerIsOnMovingPlatform);
