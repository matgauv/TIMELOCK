...
enum class BOSS_STATE {
	...
	BOSS1_GROUND_SLAM_RISE_1_STATE = BOSS1_DELAYED_PROJECTILE_ATTACK_STATE + 1,
	...
	BOSS1_GROUND_SLAM_RISE_2_STATE = BOSS1_GROUND_SLAM_LAND_1_STATE + 1,
	...
	BOSS1_GROUND_SLAM_RISE_3_STATE = BOSS1_GROUND_SLAM_LAND_2_STATE + 1,
...
enum class TEXTURE_ASSET_ID {
	...
	BOSS_ONE_GROUND_SLAM = BOSS_ONE_DASH_LEFT_RIGHT + 1,
	TEXTURE_COUNT = BOSS_ONE_GROUND_SLAM + 1,
};
...
enum class ANIMATION_ID {
	...
	SPAWNPOINT_DEACTIVATE = SPAWNPOINT_ACTIVATE + 1,
	SPAWNPOINT_REACTIVATE = SPAWNPOINT_DEACTIVATE + 1,
	BOSS_ONE_WALK = SPAWNPOINT_REACTIVATE + 1,
	BOSS_ONE_DASH = BOSS_ONE_WALK + 1,
	BOSS_ONE_GROUND_SLAM = BOSS_ONE_DASH + 1,
	ANIMATION_COUNT = BOSS_ONE_GROUND_SLAM + 1
};
