...
enum class TEXTURE_ASSET_ID {
	...
	ROLLING_THING_3 = ROLLING_THING_2 + 1,
	ROLLING_THING_4 = ROLLING_THING_3 + 1,

	DECEL_LEVEL_2_GROUND = ROLLING_THING_4 + 1,
	...
	INTRO_23 = INTRO_22 + 1,
  	...
  	DECEL_LEVEL_9_GROUND = INTRO_23 + 1,
	
	INTRO_GROUND = DECEL_LEVEL_9_GROUND + 1,
